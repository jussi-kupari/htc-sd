...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname rocket-error-starter-solved) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
...
(define (fn-for-rocket-descent rd)
  (cond [(and (number? rd) (> rd 0) (<= rd 100)) (... rd)]
        [else  (...)])) 
...
(define (has-landed? rd)
  (cond [(and (number? rd) (> rd 0) (<= rd 100)) #false]
        [else  #true])) 